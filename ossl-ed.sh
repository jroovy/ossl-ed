...
Options:
  ...
  [ -c COMPRESSION ] Compress and encrypt file(s)
...
# Encrypt
script.sh -ep Passw0rd file1 folder2 file3* ...
script.sh -ef params.txt file1 folder2 file3* ...
script.sh -ea aes-256-cbc -s sha512 -i 1000 -p Passw0rd file1 folder2 file3* ...

# Compress + Encrypt
script.sh -ecxz -m3 -p Passw0rd file1 folder2 file3* ...
script.sh -ecxz -m3 -f params.txt file1 folder2 file3* ...
script.sh -ea aes-256-cbc -s sha512 -i 1000 -p Passw0rd -cgz -m3 file1 folder2 file3* ...
script.sh -dp Passw0rd file1 folder2 file3* ...

# Tar + Encrypt
script.sh -etp Passw0rd file1 folder2 file3* ...
script.sh -etf params.txt file1 folder2 file3* ...
script.sh -eta aes-256-cbc -s sha512 -i 1000 -p Passw0rd file1 folder2 file3* ...

# Tar + Compress + Encrypt
script.sh -etcxz -p Passw0rd -o ArchiveName file1 folder2 file3* ...
script.sh -etcxz -f params.txt -o ArchiveName file1 folder2 file3* ...
script.sh -eta aes-256-cbc -s sha512 -i 1000 -p Passw0rd -cgz -m3 file1 folder2 file3* ...
script.sh -dp Passw0rd file1 folder2 file3* ...

# Decrypt (all supported file types)
script.sh -df params.txt file1 folder2 file3* ...
script.sh -dp Passw0rd archive.tar-osl
script.sh -da aes-256-cbc -s sha512 -i 1000 -p Passw0rd file1 folder2 file3* ...

"
}

ARGS=$(getopt -n openssl-encrypt -o edr:bgp:k:f:a:s:i:tzc:m:o:jh -- "$@")
eval set -- "$ARGS"
